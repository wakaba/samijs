...
uu.module.skin.plasticity = {};

/** Window Skin
 *
 * @class
 */
uu.module.skin.plasticity.window = uu.klass.generic();
uu.module.skin.plasticity.window.prototype = {
  construct:
            function(fdc) {
              this._fdc = fdc;
              this._c2d = 0;
  ...
  msgbox:   function(msg, p1, p2) {
              ...
              case "IS_INIT":
                ...
                // boneColorをベースに、明度+50%,-50%な色を生成しリサイズハンドルカラーとする
  ...
  _bone:    function(rect) {
              var pa = this._fdc.skinParam, w = rect.w, h = rect.h, i,
                  br = pa.boneRadius, bs = pa.boneShadow,
              ...
              this._c2d.setStyle({ alpha: 1.0, lineWidth: shadowWidth });
  ...
  _button:  function(x, y) {
          ...
          //    this._c2d.setStyle({ stroke: "black" }).box(x, y, 54, 18, 0, 1);
              this._c2d.image(this._img.item(0), x, y);
            },
  _resizeHandle:
            function(x, y) {
  ...
  _boneStyle:
            function(rect, rgba /* RGBAHash( {r,g,b,a} ) */ ) {
              ...
              return this._c2d.gradation([0, 0, 0, rect.h],
                                         [0.0,         { r: r, g: g, b: b, a: 1 },
                                          2 / rect.h,  uu.color.white,
                                          20 / rect.h, { r: r, g: g, b: b, a: 1 },
                                          1.0,         { r: r, g: g, b: b, a: 1 }]);
